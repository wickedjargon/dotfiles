...
script_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../root/home/new-user/.local/bin/create-qemu-vm'))
...
class TestCreateVM(unittest.TestCase):
    ...
    def test_parse_args_custom(self):
        args = parse_args(["/path/to/iso", "--name", "arch", "--arch", "aarch64", "--ram", "4G", "--disk-size", "20G"])
